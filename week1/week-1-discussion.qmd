...
janitor::clean_names() |> # turn column names into snake_case for better readability
  
# clean up dates ----
mutate(job_start_date = str_remove(job_start_date, " AM")) |> # remove 'AM' from string from job_start_date column
mutate(datetime_start = mdy_hms(job_start_date)) |> # convert from string to date (save to new col called datetime_start)
